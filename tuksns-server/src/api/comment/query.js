 ...
 * @returns 
 */
// exports.commentCreate = async (user_id, user_name, feed_id, content, sort, cmtgroup) => {
//     const query = `INSERT INTO comment
//     (user_id, user_name, feed_id, content, sort, cmtgroup)
//     VALUES (?,?,?,?,?,?)`;
//     return await pool(query, [user_id, user_name, feed_id, content, sort, cmtgroup]);
// }
